---
title: Create Chapter | FTB Quests Integration
...
> [!INFO]
> Contents of this page are from the [FTB docs](https://docs.feed-the-beast.com/docs/marketplace/Addons/quests/api)
