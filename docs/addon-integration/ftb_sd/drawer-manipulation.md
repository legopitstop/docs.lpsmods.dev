---
title: Drawer Manipulation | Storage Drawers Integration
...
> [!INFO]
> Contents of this page are from the [FTB docs](https://docs.feed-the-beast.com/docs/marketplace/Addons/storage-drawers/API/drawer_manipulation).
