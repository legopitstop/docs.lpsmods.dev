...
![Step 1](https://cdn.lpsmods.dev/data/docs/be9d5b15-4302-42b8-a7e7-f453285922b2.webp)

1. Click "Resource Packs…"

![Step 2](https://cdn.lpsmods.dev/data/docs/702a19ca-a85d-4464-bb0c-17bd47201ecc.webp)

1. Click "Open Resource Pack Folder"

![Step 3](https://cdn.lpsmods.dev/data/docs/e15d1b51-afcb-47c8-9a0f-8d8a0027544c.webp)

1. It should open File Explorer, this is where you put the resource pack you have downloaded.

![Step 4](https://cdn.lpsmods.dev/data/docs/3e69840a-5485-476f-b6fe-a4e8b7532c87.webp)
