---
title: Frequently Asked Questions | LPS Recipe Core Wiki
description: Frequently asked questions about LPS Recipe Core
prev: false
next: false
---
...
This datapack is mainly for other datapacks, so this datapack on its own doesn't have that much.
...
This pack is separate from my other packs because it means less work than copying the same code into each pack that requires custom recipes. Plus, it means others can use the API too.
...
Feel free to use this API for your pack(s). Just make sure you follow the custom license. If you plan on publishing your pack, you may not include the API code inside the download; users must download the pack here. Plus, if you let me know, I can add it to this description (free advertisement).
...
- ![v2.7.0](https://img.shields.io/badge/Recipe%20API-v2.7.0-green) For Minecraft 1.17 (incompatible with older versions.)
- ![v2.6](https://img.shields.io/badge/Recipe%20API-v2.6-green) For Minecraft 1.16
- ![v2.5](https://img.shields.io/badge/Recipe%20API-v2.5-green) For Minecraft 1.15
- ![v2.2](https://img.shields.io/badge/Recipe%20API-v2.2-green) For Minecraft 1.14
