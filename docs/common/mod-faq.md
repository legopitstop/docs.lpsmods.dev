...
This project uses the [CC BY-NC-SA 4.0 license](https://creativecommons.org/licenses/by-nc-sa/4.0/). Meaning you **cannot** sell the project or include it in paid projects.
