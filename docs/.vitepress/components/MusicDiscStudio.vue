  ...
  <div class="studio">
    ...
    <div id="content">
      ...
      <div id="project" v-if="state == 'project'">
        ...
        <img
          class="preview"
          :src="'data:image/png;base64,' + project.icon.source"
          alt="preview"
          id="iconpreview"
        />
        <input
      ...
      <div id="item" v-if="state == 'item'">
        ...
        <img
          class="preview"
          :src="'data:image/png;base64,' + project.selected.texture.source"
          alt="preview"
          id="texturepreview"
        />
        <input
