...
export class BedrockGeometry extends THREE.Group {
  ...
  rotateBone(e, t) {
    ...
    r && r.rotation.set(t.x * (Math.PI / 180), t.y * (Math.PI / 180), t.z * (Math.PI / 180));
  }
}
export class BedrockGeoLoader extends THREE.Loader {
  ...
  getGeometry(e, t) {
    switch (e.format_version) {
      case "1.12.0":
        return e["minecraft:geometry"].find((e) => e.description.identifier === t);
      default:
  ...
  getUV(e, t) {
    if (Array.isArray(e.uv)) {
      ...
      return {
        uv: [i, n],
        uv_size: [this.geo.description.texture_width, this.geo.description.texture_height],
      };
    }
